//! TXT layout structure definitions for each NF-e version.
...
pub(super) fn structure_310() -> HashMap<&'static str, &'static str> {
    structure! {
...
pub(super) fn structure_400() -> HashMap<&'static str, &'static str> {
    structure! {
...
pub(super) fn structure_400_v12() -> HashMap<&'static str, &'static str> {
    structure! {
        "NOTAFISCAL" => "NOTAFISCAL|qtd|",
        "A" => "A|versao|Id|pk_nItem|",
...
pub(super) fn structure_400_v13() -> HashMap<&'static str, &'static str> {
...
pub(super) fn structure_400_sebrae() -> HashMap<&'static str, &'static str> {
    structure! {
        "NOTAFISCAL" => "NOTAFISCAL|qtd|",
        "A" => "A|versao|Id|",
        "B" => "B|cUF|cNF|natOp|mod|serie|nNF|dhEmi|dhSaiEnt|tpNF|idDest|cMunFG|tpImp|tpEmis|cDV|tpAmb|finNFe|indFinal|indPres|indIntermed|procEmi|verProc|dhCont|xJust|",
